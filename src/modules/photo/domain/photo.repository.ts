...
export interface PhotoRepository {
  ...
  /** Igual que findById pero incluyendo `publicId` (select:false), necesario para operar en Cloudinary. */
  ...
  /** Borrado fisico: elimina la fila y (por CASCADE) sus asociaciones con productos. */
